...
def log_connection_error(service_name: str, url: str, exception: Exception, details: str = "") -> None:
    """
...
def log_connector_status(
    connector_name: str, status: str, duration: float, processed_records: int = 0, errors: int = 0, details: str = ""
) -> None:
    """
