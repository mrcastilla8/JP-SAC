...
class CRUDUsuario(CRUDBase[Usuario, UsuarioCreate, UsuarioUpdate]):
    async def create_with_auth(
        self, db: AsyncSession, *, obj_in: UsuarioCreate, current_user_id: uuid.UUID = None
    ) -> Usuario:
    ...
    async def update_status(
        self, db: AsyncSession, *, id_usuario: uuid.UUID, is_active: bool, current_user_id: uuid.UUID = None
    ) -> Usuario:
