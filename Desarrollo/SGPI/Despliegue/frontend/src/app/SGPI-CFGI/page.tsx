  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5">
        ...
        {/* Barra de Filtros */}
        <form onSubmit={handleFiltrar} className="flex flex-wrap items-end gap-3 bg-white border border-[#e2e8f0] rounded p-4">

          {/* Búsqueda */}
          <div className="flex-1 min-w-[200px]">
            <label htmlFor="buscar" className="block font-sans font-bold text-[10px] text-[#64748b] uppercase tracking-wider mb-1">
              Buscar
            </label>
            <div className="relative">
              <input
                ...
                className="w-full pl-8 pr-3 py-[7px] font-sans text-[13px] text-[#0f172a] bg-white border border-[#e2e8f0] rounded outline-none focus:ring-2 focus:ring-[#a8c8fa] transition-all"
              />
          ...
          <div className="w-[190px]">
            <label htmlFor="filtro-estado" className="block font-sans font-bold text-[10px] text-[#64748b] uppercase tracking-wider mb-1">
              Estado
            </label>
            <Select
              id="filtro-estado"
          ...
          <div className="w-[140px]">
            <label htmlFor="filtro-fuente" className="block font-sans font-bold text-[10px] text-[#64748b] uppercase tracking-wider mb-1">
              Fuente de Origen
            </label>
            <Select
              id="filtro-fuente"
          ...
          <div className="flex gap-2">
            ...
            {hayFiltrosActivos && (
              <button
                ...
                className="border border-[#e2e8f0] hover:bg-slate-50 font-sans text-[13px] text-[#475569] px-4 py-[7px] rounded transition-colors cursor-pointer"
              >
                Limpiar
              </button>
            )}
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-[#e2e8f0] bg-[#f8fafc]">
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider w-[140px]">
                    Código
                  </th>
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider">
                    Nombre del Grupo
                  </th>
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider w-[170px]">
                    Importación/Creación
                  </th>
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider w-[110px]">
                    Fuente
                  </th>
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider w-[170px]">
                    Estado
                  </th>
                  <th scope="col" className="px-5 py-3 font-sans font-bold text-[11px] text-[#64748b] uppercase tracking-wider w-[100px] text-right">
                    Acciones
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#e2e8f0]">
                {cargando ? (
                  ...
                  resultado.items.map((grupo) => (
                    <tr key={grupo.code} className="hover:bg-slate-50/60 transition-colors">
                      <td className="px-5 py-3.5 font-sans font-semibold text-[13px] text-[#0f172a]">
                        {grupo.code}
                      </td>
                      <td className="px-5 py-3.5 font-sans text-[13px] text-[#0f172a] font-medium max-w-[420px]">
                        {grupo.name}
                      </td>
