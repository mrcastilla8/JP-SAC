...
export async function getDepartamentos(): Promise<string[]> {
  return await apiClient.get<string[]>('/investigators/catalogos/departamentos');
}

export async function getNivelesRenacyt(): Promise<string[]> {
  return await apiClient.get<string[]>('/investigators/catalogos/niveles-renacyt');
}
